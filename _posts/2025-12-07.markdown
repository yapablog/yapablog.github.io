...
date: 2025-12-07
categories: others
image: assets/images/articles/2025-12-07_blog_thumb.png
toc: true
---

技術ブログを自作しました。
既存のプラットフォーム（Qiita や Zenn）も素晴らしいですが、**「html や javascript を直接いじれる自由さ」**が欲しかったのが最大の理由です。
そのおかげで、自作した便利ツールを気軽に公開することができるようになりました。
他には、広告表示の必要がないことやプラットフォーム消滅の心配が少ないことも理由に挙げられます。
収益目的ではないので、アフィリエイトリンク等は設置しない方針です。
...
少しでも html や CSS に慣れている人なら、今は AI もあるので扱いやすいかなと思います。
...
開発が完了したら、GitHub Pages を利用してアプリケーションを公開します。 大まかな流れは以下の通りです。

1. GitHub リポジトリを作成
2. package.json があるディレクトリで GitHub Pages を設定

これでデプロイは完了です。詳細な設定方法については、次を参照してください。

[GitHub 公式ドキュメント](https://docs.github.com/ja/pages/getting-started-with-github-pages/creating-a-github-pages-site)

[https://qiita.com/san_bay3/items/8338f68c9d01c8a5258b](https://qiita.com/san_bay3/items/8338f68c9d01c8a5258b)
...
この他にも目次など色々実装できるので、興味がある人はぜひチャレンジしてみてください。
